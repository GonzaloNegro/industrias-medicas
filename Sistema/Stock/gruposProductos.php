                        ...
                        if(isset($_POST['btn2']))
                                {
                                    ...
                                    while($listar = mysqli_fetch_array($consulta))
                                    {
                                        ...
                                        " 
                                        <tr>
                                        <td><h4 style='font-size:16px;'>".$listar['idGrupoProducto']."</h4 ></td>
                                        <td><h4 style='font-size:16px; text-align:left; margin-left: 5px;text-transform:uppercase'>".$listar['grupoProducto']."</h4 ></td>
                                        <td class='text-center text-nowrap'><a class='btn btn-sm btn-outline-primary' href=./modificarGrupo.php?no=".$listar['idGrupoProducto']." class=mod><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil-square' viewBox='0 0 16 16'>

...
<?php        $idd = $consulta[0];?>
        ...
        <div class="agrStock">
            ...
            <form action="../../Logica/subiendoFactura.php" method="POST" enctype="multipart/form-data">
                <div>
            ...
            <div>
                    ...
                    <input type="text" class="ocultar" name="nroFactura" id="remito" value="<?php echo $idd?>">
                ...
                <?php
                    $rut = '../upload/ventas/facturas/'.$idd;
                    ...
                    if($rutafin != ""){
                        ...
                        <div class='archivo'>
                            ...
                            <div>
                                <a class='btn btn-sm btn-outline-danger' href=../../upload/ventas/facturas/$idd.pdf download='FacturaIM.pdf'><svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' fill='currentColor' class='bi bi-filetype-pdf' viewBox='0 0 16 16'>
            ...
            <div class="agregar">
                    <a href="./facturas.php" class="volver"><i class="fa-sharp fa-solid fa-arrow-left"></i></a>
                </div>
        </div>
        </section>
    </main>

                        ...
                        if(isset($_POST['btn2']))
                                {
                                    ...
                                    while($listar = mysqli_fetch_array($consulta))
                                    {
                                        ...
                                        " 
                                            ...
                                            <td class='text-center text-nowrap'><a class='btn btn-sm' href=./detalleProducto.php?no=".$listar['idProducto']." class=mod><i class='fa-solid fa-pen-to-square fa-2x'></i></a></td>
                                            </tr>
                                        ";
                                    } 
                                }

...
<?php        $idd = $consulta[0];?>
        ...
        <div class="agrStock">
            ...
            <form action="../../Logica/subiendoLicRecibo.php" method="POST" enctype="multipart/form-data">
                <div>
                ...
                <div>
                    <label for="licRemito">Recibo</label>
                ...
                <?php
                    $rut = '../upload/licitaciones/recibo/'.$idd;
                    ...
                    if($rutafin != ""){
                        ...
                        <div class='archivo'>
                            ...
                            <div>
                                <a class='btn btn-sm btn-outline-danger' href=../../upload/licitaciones/recibo/$idd.pdf download='reciboLicitacionIM.pdf'><svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' fill='currentColor' class='bi bi-filetype-pdf' viewBox='0 0 16 16'>
            ...
            <div class="agregar">
                    <a href="./licRecibo.php" class="volver"><i class="fa-sharp fa-solid fa-arrow-left"></i></a>
                </div>
        </div>
        </section>
    </main>

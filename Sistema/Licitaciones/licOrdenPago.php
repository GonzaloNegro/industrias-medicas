...
<script type="text/javascript">
			function ok(){
				swal.fire(  {title: "Se ha aceptado la factura correctamente.",
						icon: "success",
    ...
    <main>
        <section class="ini">
            ...
            <div class="container">
                ...
                <form method="POST" action="./licOrdenPago.php">
                        ...
                        if(isset($_POST['btn2']))
                                {
                                    ...
                                    WHERE m.idEstadoLicitacion = 5 AND (l.idLicitacion LIKE '%$doc%' OR m.fecha LIKE '%$doc%' OR u.usuario LIKE '%$doc%')
                                    ...
                                    while($listar = mysqli_fetch_array($consulta)) 
                                    {
                                        ...
                                        " 
                                            ...
                                            <td class='text-center text-nowrap'><a href=./subirLicOrdenPago.php?no=".$listar['idLicitacion']." class='btn btn-sm btn-outline-danger'><i class='fa-solid fa-cloud-arrow-up'></i></a></td>
                                            </tr>
                                        ";
                                    } 
                                }
                            ...
                            if(isset($_POST['btn2']))
                                    {
                                        ...
                                        LEFT JOIN datoslicitacion AS da ON da.idLicitacion = l.idLicitacion
                                        LEFT JOIN usuario AS u ON u.idUsuario = da.idUsuario
                                        WHERE m.idEstadoLicitacion = 5 AND (l.idLicitacion LIKE '%$doc%' OR m.fecha LIKE '%$doc%' OR u.usuario LIKE '%$doc%') AND da.idUsuario = '$idUsu'
                                        GROUP BY l.idLicitacion
                                        ORDER BY l.idLicitacion DESC");
                                        while($listar = mysqli_fetch_array($consulta)) 
                                        {
                                        ...
                                        LEFT JOIN datoslicitacion AS da ON da.idLicitacion = l.idLicitacion
                                        LEFT JOIN usuario AS u ON u.idUsuario = da.idUsuario
                                        WHERE m.idEstadoLicitacion = 5 AND da.idUsuario = '$idUsu'
                                        GROUP BY l.idLicitacion
                                        ORDER BY l.idLicitacion DESC");
                                        while($listar = mysqli_fetch_array($consulta)) 
                                        {

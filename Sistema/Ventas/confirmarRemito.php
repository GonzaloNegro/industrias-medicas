...
<div class="cont-img">
    ...
    <main>
        ...
        <div class="agrStock">
            <form method="POST" action="../../Logica/agregandoFactura.php">
                <div>
                ...
                <div>
                    ...
                    echo 
                        "
                        <a class='btn btn-sm btn-outline-danger' href=../../upload/ventas/remitos/$idd.pdf download='remitoIM.pdf'><svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' fill='currentColor' class='bi bi-filetype-pdf' viewBox='0 0 16 16'>
                    ...
                    <table class="table">
                        ...
                        WHERE pr.idDocumento = '$consulta[0]'";
                ...
                <?php if($rutafin != "" AND $est == 4 AND $idRol == 5){?>
                <div>

        ...
        <section class="ini">
            ...
            <?php
                    echo "<table>
                            <thead>
                                <tr>
                                    <th style='width:150px;'><p style='text-align:right; margin-right: 5px;'>N°DOCUMENTO</p></th>
                                    <th><p>FECHA</p></th>
                        ...
                        if(isset($_POST['btn2']))
                                {
                                    ...
                                    WHERE d.idEstadoDocumento = 8  AND (m.idDocumento LIKE '%$doc%' OR m.fecha LIKE '%$doc%' OR u.usuario LIKE '%$doc%' OR da.medico LIKE '%$doc%' OR da.paciente LIKE '%$doc%')
                                    ...
                                    while($listar = mysqli_fetch_array($consulta))
                                    {
                                        ...
                                        " 
                                            ...
                                            <td class='text-center text-nowrap'><a class='btn btn-sm' href=./detalleRevisionStock.php?no=".$listar['idDocumento']." class=mod><i class='fa-solid fa-pen-to-square fa-2x'></i></a></td>
                                            </tr>
                                        ";
                                    } 
                                }

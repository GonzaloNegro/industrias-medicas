...
<script type="text/javascript">
			function ok(){
				swal(  {title: "Se ha aceptado la Orden de compra",
						icon: "success",
...
<script type="text/javascript">
function cargado(){
    swal(  {title: "Se ha cargado correctamente su remito.",
            icon: "success",
            showConfirmButton: true,
            showCancelButton: false,
            });
...
<script type="text/javascript">
function no(){
    swal(  {title: "Se ha rechazado la Orden de compra",
            icon: "error",
            showConfirmButton: true,
            showCancelButton: false,
            });
    ...
    <main>
        <section class="ini">
            ...
            <div class="container">
                ...
                <form method="POST" action="./licRemitos.php">
                        ...
                        if(isset($_POST['btn2']))
                                {
                                    ...
                                    while($listar = mysqli_fetch_array($consulta)) 
                                    {
                                        ...
                                        " 
                                            ...
                                            <td class='text-center text-nowrap'> <a class='btn btn-sm btn-outline-danger' href=./confirmarLicRemito.php?no=".$listar['idLicitacion']." target=new><svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' fill='currentColor' class='bi bi-filetype-pdf' viewBox='0 0 16 16'>
                                          ...
                                          ";
                                            if($idUsu == 1){
                                                echo 
                                                "
                                                <td class='text-center text-nowrap'><a href=./subirLicRemito.php?no=".$listar['idLicitacion']." class='btn btn-sm btn-outline-danger'><i class='fa-solid fa-cloud-arrow-up'></i></a></td>
                                                ";
                                            }

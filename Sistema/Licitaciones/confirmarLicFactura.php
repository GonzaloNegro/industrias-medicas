        ...
        <div class="agrStock">
            <form method="POST" action="../../Logica/agregandoLicOrdenPago.php">
                <div>
                    ...
                    $rut = '../upload/licitaciones/facturas/'.$idd;
                    ...
                    echo 
                        "
                        <a class='btn btn-sm btn-outline-danger' href=../../upload/licitaciones/facturas/$idd.pdf download='FacturaLicitacionIM.pdf'><svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' fill='currentColor' class='bi bi-filetype-pdf' viewBox='0 0 16 16'>
            ...
            <div class="agregar">
                    <a href="./licFacturas.php" class="volver">VOLVER</a>
                </div>
        </div>
        </section>
    </main>

...
<div class="cont-img">
    ...
    <main>
        ...
        <div class="agrStock">
            <form method="POST" action="../../Logica/agregandoLicRecibo.php">
                <div>
                    ...
                    $rut = '../upload/licitaciones/ordenPago/'.$idd;
                    ...
                    echo 
                        "
                        <a class='btn btn-sm btn-outline-danger' href=../../upload/licitaciones/ordenPago/$idd.pdf download='ordeDePagoLicitacionIM.pdf'><svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' fill='currentColor' class='bi bi-filetype-pdf' viewBox='0 0 16 16'>

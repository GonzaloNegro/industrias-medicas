                        ...
                        if(isset($_POST['btn2']))
                                {
                                    ...
                                    while($listar = mysqli_fetch_array($consulta)) 
                                    {
                                        ...
                                        <td><h4 style='font-size:14px;'>".$listar['cantidad']."</h4 ></td>
                                        <td class='text-center text-nowrap'><a class='btn btn-sm btn-outline-primary' href=./detalleSolicitud.php?no=".$listar['idSolicitud']." class=mod><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil-square' viewBox='0 0 16 16'>

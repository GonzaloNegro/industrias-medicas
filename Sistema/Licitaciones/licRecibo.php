...
<script type="text/javascript">
			function ok(){
				swal.fire(  {
                        title: "Se ha aceptado la orden de pago correctamente.",
                        text: 'Ya puede proceder a realizar la carga del recibo',
						icon: "success",
...
<?php include('../Layouts/licitacionesHeader.php'); ?>
    <main>
        <section class="ini">
            <div class="ini-tit">
                <h1>LICITACIONES</h1>
                <h5>RECIBO DE PAGO DE PROVEEDORES</h5>
            </div>
            <div class="container">

                <form method="POST" action="./licRecibo.php">
                                    ...
                                    while($listar = mysqli_fetch_array($consulta)) 
                                    {
                                        ...
                                        " 
                                            <tr>
                                                ...
                                                <td class='text-center text-nowrap'> <a class='btn btn-sm btn-outline-danger' href=./confirmarLicRecibo.php?no=".$listar['idLicitacion']." target=new><svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' fill='currentColor' class='bi bi-filetype-pdf' viewBox='0 0 16 16'>
                                        ...
                                        while($listar = mysqli_fetch_array($consulta)) 
                                        {
                                            ...
                                            " 
                                                <tr>
                                                    ...
                                                    <td><h4 style='font-size:16px;'>".$fec."</h4 ></td>
                                                    <td><h4 style='font-size:16px;text-transform:uppercase;text-align: left; margin-left: 5px;'>".$listar['usuario']."</h4 ></td>
                                                    <td class='text-center text-nowrap'><a href=./subirLicRecibo.php?no=".$listar['idLicitacion']." class='btn btn-sm btn-outline-danger'><i class='fa-solid fa-cloud-arrow-up'></i></a></td>
                                                </tr>
                                            ";
                                        } 
                                    }
